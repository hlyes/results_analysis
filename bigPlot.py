					...
					for r in repartions:
						for br in bad_repartition:
							for maxN in maxNodes:
								for fc in fastC:
									if fc == 1:
										suffix = str(strategy)+"-"+str(s)+"-"+str(maxN)+"-"+str(cs)+'-'+str(maxAP)+"-"+str(maxD2D)+"-"+str(r)+"-"+str(br)+"-1.0"
									else:
										suffix = str(strategy)+"-"+str(s)+"-"+str(maxN)+"-"+str(cs)+'-'+str(maxAP)+"-"+str(maxD2D)+"-"+str(r)+"-"+str(br)+"-"+fc
